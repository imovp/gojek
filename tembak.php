...
echo color("red","| Creator : Agus Syahputra            |\n");
...
// function change(){
        ...
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"JEPANG"}');
        ...
        sleep(3);
        $boba10 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOPAYDIXXI5"}');
        ...
        echo "\n".color("yellow","!] Claim voc JAJANHEMAT");
        echo "\n".color("yellow","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
        ...
        sleep(3);
        $boba19 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"JAJANHEMAT"}');
        ...
        echo "\n".color("green","+] Message: ".$messageboba19);
        goride:
        echo "\n".color("yellow","!] Claim voc MILODINOSAURS1");
        echo "\n".color("yellow","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
        ...
        sleep(3);
        $goride = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"MILODINOSAURS1"}');
